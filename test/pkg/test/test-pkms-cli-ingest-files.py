...
def test_pkms_cli_ingest_files():
    ...
    test_file1_path = test_collections_path / 'html' / '0001-01-01-0001 PKMS Search.html'
    test_file2_path = test_collections_path / 'html' / '2026-01-18-1604b853 PKMS Search.html'
    ...
    argv = [
        ingest.files.__file__, 
        test_file1_path.as_posix(),
        test_file2_path.as_posix(),
        '--workspace-dir', test_workspace_dir.as_posix(),
        '--config-path', test_workspace_config_path.as_posix(),
    ]
    assert ingest.files.main(argv) == 0
